...
namespace Lms.DataLayer.Migrations
{
    ...
    [Migration("20220206070133_mig_UpdateHistoryTbl")]
    partial class mig_UpdateHistoryTbl
    {
            ...
            modelBuilder.Entity("Lms.DataLayer.Entities.QuestionHistory", b =>
                {
                    ...
                    b.Property<int?>("UserStatusExamStatusId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserStatusExamStatusId");
            ...
            modelBuilder.Entity("Lms.DataLayer.Entities.QuestionHistory", b =>
                {
                    ...
                    b.HasOne("Lms.DataLayer.Entities.UserStatus", null)
                        .WithMany("QuestionHistories")
                        .HasForeignKey("UserStatusExamStatusId");
