...
namespace Lms.DataLayer.Migrations
{
    ...
    [Migration("20220228141542_UpdateCommentTbl")]
    partial class UpdateCommentTbl
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lms.DataLayer.Entities.CourseComment", b =>
                {
            ...
            modelBuilder.Entity("Lms.DataLayer.Entities.CourseEpisode", b =>
                {
            ...
            modelBuilder.Entity("Lms.DataLayer.Entities.CourseLevel", b =>
                {
                    b.Property<int>("LevelId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Lms.DataLayer.Entities.CourseStatus", b =>
                {
                    b.Property<int>("StatusId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Lms.DataLayer.Entities.CourseVote", b =>
                {
            ...
            modelBuilder.Entity("Lms.DataLayer.Entities.Discount", b =>
                {
            ...
            modelBuilder.Entity("Lms.DataLayer.Entities.MultipleQuestion", b =>
                {
                    ...
                    b.Property<string>("Alternate4")
                        .IsRequired()
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");

                    b.Property<string>("Alternate4File")
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");
            ...
            modelBuilder.Entity("Lms.DataLayer.Entities.UserDiscountCode", b =>
                {
            ...
            modelBuilder.Entity("Lms.DataLayer.Entities.Course", b =>
                {
                    ...
                    b.HasOne("Lms.DataLayer.Entities.CourseLevel", "CourseLevel")
                        .WithMany("Courses")
                        .HasForeignKey("LevelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Lms.DataLayer.Entities.CourseStatus", "CourseStatus")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("Lms.DataLayer.Entities.UserDiscountCode", b =>
                {
                    b.HasOne("Lms.DataLayer.Entities.Discount", "Discount")
